-- ============================================================
-- Migration 072: Wholesale pricing RPC update
--
-- Adds is_wholesale flag to submit_sale_batch so wholesale sales
-- are recorded in the sales table.
-- ============================================================

BEGIN;

-- Drop old function signature to avoid overload ambiguity
