...
const navItems: NavItem[] = [
  ...
  { href: "/reorder", label: "Reorder List", icon: Send, roles: ["admin"], retailOnly: true, group: "shop" },
  ...
  { href: "/warehouse/transfers", label: "WMS Transfers", icon: ArrowLeftRight, roles: ["admin"], wmsOnly: true, group: "warehouse" },
    ...
    <>
      ...
      >
        ...
        <div className="px-4 pb-1">
          <a
            href={role === "cashier" ? "/cashier-guide.html" : "/manual.html"}
            target="_blank"
          ...
          >
            ...
            <span>{role === "cashier" ? "Cashier Guide" : "User Manual"}</span>
          </a>
        </div>
